...
public class CacheDecoratorTxTest extends ATxTest {
	...
	public void commit_rollback_dueToError() throws IOException {
		...
		repository = pojoDB.newDomainRepository(Pojo.class, new LongCounterIdGenerator<>(), new CacheDecoratorStorageBackend<>(fileProvider, Pojo.class));
