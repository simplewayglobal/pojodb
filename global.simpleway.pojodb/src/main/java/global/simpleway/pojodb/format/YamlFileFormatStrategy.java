...
/**
 * YAML format for the flat file storage
 * 
 */
public class YamlFileFormatStrategy implements IFileFormatStrategy {

	//thread safe instance of jackson mapper configured for the YAML file format 
